...
const apStart = content.indexOf("{activeTab === 'inventory' && (");
const apEnd = content.lastIndexOf("</AnimatePresence>") + "</AnimatePresence>".length;
...
console.log('App.tsx correctly updated with lastIndexOf');
